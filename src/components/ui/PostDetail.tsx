...
const PostDetail: React.FC<PostDetailProps> = ({ post, activeTab, onPostClick, onEditPostClick }) => {
    const { email } = useAuth();
    return (
        <article
        key={post.id}
    ...
    >
        <div className="tag flex items-center space-x-4">
            ...
            <section className="post-content rounded-lg mt-4 flex justify-center items-center w-[736px] h-[432px] bg-[#CBD5E1] "></section>
